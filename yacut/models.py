...
from settings import URL_LENGTH, FIELDS_MODEL_TO_API_DICT, DOMAIN
...
class URLMap(db.Model):
    ...
    short_link = db.Column(db.String(URL_LENGTH), nullable=False)
    ...
    def set_short_link(self):
        ...
        self.short_link = f'{parsed_url.scheme}://{parsed_url.hostname}/{self.short}'
